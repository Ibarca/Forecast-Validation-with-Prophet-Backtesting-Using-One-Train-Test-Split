...
The table gives a compact overview of the forecast performance:
...
One important detail: MAPE can become misleading when actual sales are very low or zero. In those cases, the percentage error can become extremely large, so it should be interpreted together with MAE, RMSE, and Bias.
